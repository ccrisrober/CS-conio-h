...
public class ConfiguracionLR {
    ...
    private final Object[][] tablaAccion;
    private final int[][] tablaGoto;
    private final int magicNumberX = 12;
    private final int magicNumberY1 = 6;
    private final int magicNumberY2 = 3;

    public ConfiguracionLR() {
        this.tablaAccion = new Object[magicNumberX][magicNumberY1];
